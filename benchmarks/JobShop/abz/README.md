# ABZ (Adams, Balas & Zawack, 1988) Benchmark Family

## Background
Classic benchmark set introduced with shifting bottleneck ideas; frequently used for medium/hard comparisons.

## Family profile

- Prefix: `abz`
- Instances: abz5-abz9
- Size range: 10x10, 20x15
- Instances with unknown optimum in metadata: 1
